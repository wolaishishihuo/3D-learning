  ...
  <div class="demos-page relative min-h-screen overflow-hidden bg-[#000]">
    ...
    <div class="relative z-10 container mx-auto px-4 py-12">
      ...
      <div class="flex flex-col items-center justify-center mb-16 text-center">
        <h1 class="text-6xl font-extrabold tracking-tight mb-4 text-white">3D Learning</h1>
      ...
      <!-- Controls Section -->
      <div
        class="flex flex-col md:flex-row gap-6 justify-between items-center mb-12 glass-panel p-4 rounded-2xl"
      >
        <!-- Search -->
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        >
          ...
          >
            ...
            <div
              class="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-white"
            ></div>

            <div
              class="absolute inset-0 flex items-center justify-center transform group-hover:scale-105 transition-transform duration-700"
            >
              <span class="text-6xl text-white/80 group-hover:text-white transition-colors">{{
                demo.icon
              }}</span>
            </div>
          ...
          <div class="p-5 flex-1 flex flex-col">
            ...
            <div
              class="flex items-center justify-between text-xs text-gray-500 border-t border-white/5 pt-4 mt-auto"
            >
              <span class="flex items-center gap-1">
                <span
                  class="w-1.5 h-1.5 rounded-full bg-white/60 group-hover:bg-white transition-colors"
                ></span>
